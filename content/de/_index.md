...
go-mail ist ein einfach zu bedienendes Go-Modul zum Formatieren und Versenden von E-Mails. Es verwendet einen idiomatischen Go-Stil und folgt Best Practices mit vernünftigen Standards. Die Bibliothek hängt nur von der Go-Standardbibliothek ab.

go-mail funktioniert wie ein programmatischer E-Mail-Client und bietet viele Methoden und Funktionalitäten, die Sie als Standard in einem MUA betrachten würden.

<div class="btn-centered btn-huge">
{{< button size="huge" relref="getting-started/introduction/" >}}Beginne mit go-mail{{< /button >}}
</div>
...
go-mail benötigt keine Module von Drittanbietern und läuft nur auf der Go-Standardbibliothek
